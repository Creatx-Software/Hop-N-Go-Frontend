...
const TravelerQuiz = () => {
  return (
    <section className="container relative py-[5vw] overflow-hidden">
      ...
      <div className="w-full md:px-0 mx-auto relative z-10">
        <div className="grid md:grid-cols-2 gap-[3vw] items-center">
          ...
          <div>
            ...
            <Button size="lg"
              className="bg-[#F74A1F] text-white rounded-full w-full sm:w-auto px-[2.5vw] py-[0.75vw] h-[3.5vw] min-h-[56px] text-[4.1vw] lg:text-[1vw] xl:text-[1.1vw] font-medium shadow-lg border-none focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#F9AC7D]"
            >
              Take Our Quiz
            </Button>
          </div>
