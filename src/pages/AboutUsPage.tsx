    ...
    <div className="min-h-screen flex flex-col overflow-x-hidden">
      ...
      <section className="relative w-full min-h-screen overflow-hidden mt-16">
        ...
        <div className="relative z-10 h-full flex flex-col justify-center items-center text-center px-6 md:px-0 mt-32">
          ...
          <p className="text-white/90 text-lg md:text-xl font-inter font-medium italic px-2 md:px-20 mb-12">
          ...
          <div className="w-full lg:w-7/12">
            ...
            <div className="mt-6 w-full relative">
              <img 
                ...
                className="w-full h-auto object-cover rounded-lg"
              />
              <ArrowRight className="absolute bottom-4 right-4 w-16 h-16 md:w-32 md:h-32 text-[#F07026] bg-[#0F1011] rounded-full p-2" />
            </div>
          </div>

          {/* Content Section - Right Side */}
          <div className="w-full lg:w-7/12 bg-transparent p-0 px-4 md:px-8 lg:px-24 mt-8 lg:mt-[30rem]">
